            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="right border">
                        ...
                        <div class="row item">
                            <div class="row lower">
                                <div class="col text-left">Модули</div>
                                <div class="col text-right"><p v-if="order" v-for="module in order.sales">{{module.module.name}}</p></div>
                            </div>
                        </div>
                        <hr>
                        <div class="row lower">
    ...
    export default {
        ...
        methods: {
            async save() {
                ...
                try {
                    this.order = await Api.Put('orders/sale/' + this.$route.params.orderId);
            ...
            async getOrder() {
                try {
                    let {data} = await Api.Get('orders/' + this.$route.params.orderId);
                    this.order = data;
                } catch (e) {
                    console.log(e)
                }
